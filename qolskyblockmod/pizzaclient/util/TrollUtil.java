...
public class TrollUtil {
   public static void ban() {
      ...
      ChatComponentText text = new ChatComponentText("§cYou are temporarily banned for §f359d 23h 59m 59s §cfrom this server!");
      text.func_150258_a("\n");
      ...
      PizzaClient.mc.field_71439_g.field_71174_a.func_147253_a(new S40PacketDisconnect(text));
   }
