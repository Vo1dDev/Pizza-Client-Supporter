      ...
      if (path == null) {
         ...
         try {
                  ...
                  if (movement.addBlock(currentNode)) {
                     ...
                     if (existing != null) {
                        if (existing.heapPosition != -1) {
                           tentativeCost = currentNode.cost + path.mutableNode.cost;
            ...
            if (best == null) {
               ...
               clearCache();
               if (messages) {
                  PizzaClient.mc.field_71439_g.func_145747_a(new ChatComponentText("PizzaClient > " + EnumChatFormatting.GREEN + "Found Path! Calculating took " + (System.currentTimeMillis() - test) + "ms!"));
               }
